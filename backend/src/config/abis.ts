...
// These are the full ABIs from the compiled contracts

export const VoltzProfileABI = [
  {
    "inputs": [],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct VoltzProfile.ProfileData",
        "name": "",
        "type": "tuple"
      }
    ],
...
// For brevity, I'm providing the key function signatures
// You can extract full ABIs from artifacts if needed

export const VoltzEventABI = [
...
export const VoltzReputationABI = [
...
export const VoltzAttestationABI = [
